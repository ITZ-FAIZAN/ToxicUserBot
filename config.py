...
_PMPERMIT_TEXT = """
Hey ! This is [Toxic Userbot](https://t.me/ToxicUbSupport) Security System.
...
# ---- pmpermit ----
    ...
    PMPERMIT_PIC = os.getenv("PMPERMIT_PIC", "https://telegra.ph//file/6de723b26595542b7be22.jpg")
...
# ---- user ----
    ...
    # used for alive plugin (default: toxicuserbot logo image)
    USER_PIC = os.getenv("USER_PIC", "https://telegra.ph//file/6de723b26595542b7be22.jpg")
...
# --- bot ----
    ...
    BOT_NAME = os.getenv("BOT_NAME", "Toxic")
    # provide this if bot fails to get (optional)
...
# ---- assistant ----
    ...
    ASSISTANT_PIC = os.getenv("ASSISTANT_PIC", "./main/core/resources/images/Toxic.png")
    # set your assistant about text
    ASSISTANT_TEXT = os.getenv("ASSISTANT_TEXT", "")

# ---- other ----
    # your telegraph account name (default: toxicuserbot)
    TL_NAME = os.getenv("TL_NAME", "Tron UserBot")
    # thumbnail used while uploading plugins, etc. (optional)
    THUMB_PIC = os.getenv("THUMB_PIC", "./main/core/resources/images/toxic-square.png")
    # temporary download location (required)
    TEMP_DICT = os.getenv("TEMP_DICT", os.path.abspath(".") + "/downloads/")
    # official repo for updates
    UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/ITZ-FAIZAN/ToxicUserBot.git")
